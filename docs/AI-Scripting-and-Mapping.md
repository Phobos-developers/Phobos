...
- `TeamDelays.One/Two/Three/Four/Five/Six/Seven/EightPlayer(s)` control the team delay when the amount of players meets the above conditions respectively. Consisted by 3 integers that represent each difficulty.
