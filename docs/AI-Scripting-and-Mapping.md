...
### `16011` Conditional Jump, Clear Variables
...
### `16012` Conditional Jump, Manage Variables Reset If The Jump Is Successful
...
- This action behavior isn't affected by the Action `16011` "Reset Variables".

In `aimd.ini`:
```ini
[SOMESCRIPTTYPE]  ; ScriptType
x=16012,0         ; Integer, 1 = true, 0 = false
```

### `16013` Action Abortion After Success Kill
...
```ini
[SOMESCRIPTTYPE]  ; ScriptType
x=16013,0         ; integer, 0 for disable it, 1 for enable it
```

### `16014` Conditional Jump, Manage Kills Counter
...
### `16015` Conditional Jump, Reset Counter
...
### `16016` Conditional Jump, Set Comparator Mode
- Sets the comparator used in conditional jumps.

In `aimd.ini`:
```ini
[SOMESCRIPTTYPE]  ; ScriptType
x=16016,3         ; integer, from 0 to 5, default to 3 (>=)
```
...
### `16017` Conditional Jump, Set Comparator Value
...
### `16018` Conditional Jump, Set Index
...
### `16019` Conditional Jump, Check Kills Count
...
### `16022` Conditional Jump, Check Simple Count
...
- The count can be reseted using the script action `16015`.
...
### `16024` Conditional Jump, Check Enemy Objects Count
- Count the number of enemy living object instances and saves the result for the conditional jump evaluation.
- The list of objects that will be used by this Action is selected by the Script Action `16018`.
