...
VisibleToHouses=owner                          ; Affected House Enumeration (none|owner/self|allies/ally|team|enemies/enemy|civilian|special|neutral|all)
...
VisibleToHouses=all                     ; Affected House Enumeration (none|owner/self|allies/ally|team|enemies/enemy|civilian|special|neutral|all)
VisibleToHouses.Observer=true           ; boolean
...
DisplayIncome.Houses=all   ; Affected House Enumeration (none|owner/self|allies/ally|team|enemies/enemy|civilian|special|neutral|all)
