...
- Fixed the bug where initial payload cannot fire in `OpenTopped=yes` transporter when transporter step on a location that payload cannot reach there (by NetsuNegi)
