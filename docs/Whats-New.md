...
- Recycle spawned in long-range (by 航味麻酱)
- Play an anim when recycling a spawned (by 航味麻酱)
...
- Buildings with foundation bigger than 1x1 can now recycle spawned correctly (by 航味麻酱)
