...
- Fixed the bug that a unit can overlap with `Teleport=yes` units after it's been damaged by a fallen unit lifted by `IsLocomotor=yes` warheads (by NetsuNegi)
