...
- Fixed an issue that `MovementZone=Fly` harvesters can not be able to enter refinery buildings (by CrimRecya)
- Fixed an issue that jumpjet harvester will overlap when entering refinery buildings and cause game crashes (by CrimRecya)
