...
RandomTarget.Spawners.RememberTargets=true  ; boolean
RandomTarget.MissChance=0.0                  ; double or percentage
RandomTarget.FriendlyFireChance=0.0          ; double or percentage
```
