...
(actor).Filter.AEStacks.Types=                     ; list of AttachedEffectTypes
(actor).Filter.AEStacks.Methods=                   ; list of comparing methods (e|g|ge|l|le|ne) or (Equal|Greater|GreaterEqual|Lower|LowerEqual|NotEqual)
(actor).Filter.AEStacks.Values=                    ; list of integer
