...
- Fixed the bug that restored cyborg legs when the soldier left transport. Old behavior can be enabled back with `rulesmd.ini->[SOMETECHNO]->CanRepairCyborgLegs=true`.
