...
- You can now customize veterancy insignia of TechnoTypes.
  ...
  - Position for insignias can be adjusted by setting `DrawInsignia.AdjustPos.Infantry` for infantry, and `DrawInsignia.AdjustPos.Techno` for others.
...
DrawInsignia.AdjustPos.Techno=10,6  ; X,Y, position offset from default
