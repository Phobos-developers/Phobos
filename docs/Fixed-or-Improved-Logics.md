...
- Translucent SHPs are now drawn using a more precise (has no green tint in particular) and performant algorithm.
  - Currently only applies to Compression 3 SHPs.
