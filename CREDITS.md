...
- **NetsuNegi**:
  ...
  - Fix the bug where units with passengers being removed were incorrectly counted in `LimboTracker` due to bypassing `UnInit`, affecting auto-death and superweapon auxiliary techno checks
