...
- **FS-21** - Dump Object Info enhancements, Powered.KillSpawns, Spawner.LimitRange, ScriptType Actions 71, 72, 73, 74 to 81, 92, 93, 94, 95 to 98, 112, MC deployer fixes, help with docs, Automatic Passenger Deletion
...
- **Morton (MortonPL)** - XDrawOffset, Shield Passthrough & Absorbtion
