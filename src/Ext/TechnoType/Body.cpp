...
int TechnoTypeExt::ExtData::SelectForceWeapon(TechnoClass* pThis, AbstractClass* pTarget)
{
	...
	{
		if (this->ForceWeapon_Naval >= 0 && pTargetType->Naval)
		{
			forceWeaponIndex = this->ForceWeapon_Naval;
		}
		else
		{
			switch (pTarget->WhatAmI())
			{
				...
				{
					if (this->ForceAAWeapon_Infantry >= 0 && pTarget->IsInAir())
						forceWeaponIndex = this->ForceAAWeapon_Infantry;
					else
						forceWeaponIndex = this->ForceWeapon_Infantry;

					break;
				}
				case AbstractType::Unit:
				{
					if (this->ForceAAWeapon_Units >= 0 && pTarget->IsInAir())
						forceWeaponIndex = this->ForceAAWeapon_Units;
					else
						forceWeaponIndex = this->ForceWeapon_Units;

					break;
				}
				case AbstractType::Aircraft:
				{
					if (this->ForceAAWeapon_Aircraft >= 0 && pTarget->IsInAir())
						forceWeaponIndex = this->ForceAAWeapon_Aircraft;
					else
						forceWeaponIndex = this->ForceWeapon_Aircraft;
