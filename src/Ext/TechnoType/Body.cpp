...
void TechnoTypeExt::ExtData::LoadFromINIFile(CCINIClass* const pINI)
{
	...
	this->OpenTopped_OpportunityFire.Read(exINI, pSection, "OpenTopped.OpportunityFire");
	...
	this->OpenTransport_OpportunityFire.Read(exINI, pSection, "OpenTransport.OpportunityFire");
