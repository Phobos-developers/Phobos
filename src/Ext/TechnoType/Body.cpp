...
void TechnoTypeExt::ExtData::LoadFromINIFile(CCINIClass* const pINI)
{
	...
	this->AutoDeath_PassengersExceed.Read(exINI, pSection, "AutoDeath.PassengersExceed");
	this->AutoDeath_PassengersBelow.Read(exINI, pSection, "AutoDeath.PassengersBelow");
	...
	this->AutoDeath_OnAnyCondition.Read(exINI, pSection, "AutoDeath.OnAnyCondition");
...
void TechnoTypeExt::ExtData::Serialize(T& Stm)
{
	Stm
		...
		.Process(this->AutoDeath_PassengersExceed)
		.Process(this->AutoDeath_PassengersBelow)
		...
		.Process(this->AutoDeath_OnAnyCondition)
