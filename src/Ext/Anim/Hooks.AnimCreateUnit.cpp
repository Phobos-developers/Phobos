...
DEFINE_HOOK(0x424932, AnimClass_AI_CreateUnit_ActualEffects, 0x6)
{
	...
	if (auto const pUnitType = pTypeExt->CreateUnit.Get())
	{
		...
		TechnoTypeExt::CreateUnit(pUnitType, pThis->Location, primaryFacing, secondaryFacing, pThis->Owner, pTypeExt->CreateUnit_SpawnAnim,
			pExt->Invoker, pExt->InvokerHouse, pTypeExt->CreateUnit_SpawnHeight, pTypeExt->CreateUnit_AlwaysSpawnOnGround, pTypeExt->CreateUnit_ConsiderPathfinding,
