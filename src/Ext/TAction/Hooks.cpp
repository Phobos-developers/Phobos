...
// TODO: Refactor to fix buildup anim and pathfinding issue: Buildup anims plays while the building image is already there.
// Bugfix: TAction 125 Build At do not display the buildups Author: secsome
