...
bool TechnoExt::ExtData::CheckDeathConditions(bool isInLimbo)
{
	...
	TechnoExt::KillSelf(pThis, pTypeExt->AutoDeath_Behavior.Get(), pTypeExt->AutoDeath_Weapon, pTypeExt->AutoDeath_VanishAnimation, isInLimbo, pTypeExt->Convert_AutoDeath.Get());
	return true;
}
...
void TechnoExt::KillSelf(TechnoClass* pThis, AutoDeathBehavior deathOption, WeaponTypeClass* pWeapon, AnimTypeClass* pVanishAnimation, bool isInLimbo, TechnoTypeClass* pConvert)
{
	if (isInLimbo)
	{
