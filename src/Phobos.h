...
public:
	...
	public:
		...
		static COLORREF ColorTextButton;
		static COLORREF ColorTextCheckbox;
		static COLORREF ColorTextRadio;
		static COLORREF ColorTextLabel;
		static COLORREF ColorTextList;
		static COLORREF ColorTextCombobox;
		static COLORREF ColorTextGroupbox;
		static COLORREF ColorTextSlider;
		static COLORREF ColorTextEdit;
		static COLORREF ColorTextObserver;
		static COLORREF ColorCaret;
		static COLORREF ColorSelection;
		static COLORREF ColorSelectionCombobox;
		static COLORREF ColorSelectionList;
		static COLORREF ColorSelectionObserver;
		static COLORREF ColorBorder1;
		static COLORREF ColorBorder2;
		static COLORREF ColorDisabled;
		static COLORREF ColorDisabledLabel;
		static COLORREF ColorDisabledButton;
		static COLORREF ColorDisabledCombobox;
		static COLORREF ColorDisabledCheckbox;
		static COLORREF ColorDisabledSlider;
		static COLORREF ColorDisabledList;
		static COLORREF ColorDisabledObserver;
